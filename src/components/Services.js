...
const services = [
  ...
  
 {
    ...
    description: "Proficient in server-side development using Node.js and express js. I design robust APIs and manage databases like MySQL and MongoDB to provide secure, scalable, and efficient back-end solutions."
  },
  {
