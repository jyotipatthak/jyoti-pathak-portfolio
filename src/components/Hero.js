...
const Hero = () => (
  <section className="hero">
    ...
    >
      <img src="" alt="Preeti" className="hero-image" />
      <div>
        <h2>Hello, world! 🌍</h2>
        <p>

          I'm Jyoti, a full-stack software engineer with a passion for turning complex problems into simple, elegant solutions. Whether I'm coding up sleek apps in React Native or diving deep into the backend with Laravel and Node.js, I’m always on the lookout for my next big challenge.
        </p>
        <p>
